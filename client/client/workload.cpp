...
void workload_vt::create_workload_mrc20_detail(int _to, int _from, int count, FILE* fp, int *amount) {
...
void workload_vt::create_workload_mrc20(int _to, int _from, int count, std::string PATH) {
    ...
    fp = fopen(path1.c_str(), "w");
    create_workload_mrc20_detail(_to, _from, count, fp, amount);
    fclose(fp);

    fp = fopen(path2.c_str(), "w");
    create_workload_mrc20_detail(_from, _to, count, fp, amount);
    fclose(fp);
}
