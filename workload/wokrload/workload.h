...
public:
    ...
    void create_workload_mrc20(int _to, int _from, int count, std::string PATH, int mode);
    void create_workload_mrc20_detail(int _to, int _from, int count, FILE* fp, int* amount, int mode);
